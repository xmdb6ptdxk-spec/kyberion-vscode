...
class ChatViewProvider {
    constructor(extensionUri, forgeClient, fileHandler) {
     ...
     * Plan erstellen
     */
    async handleCreatePlan(taskDescription) {
        if (!this.isConnected) {
            this.postMessage({
                type: 'error',
     ...
     */
    extractPlanFromResponse(response, originalTask) {
        try {
...
ChatViewProvider.viewType = 'kyberion.chatView';
